...
public class RSADemo {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
       ...
       //String publickey = keyMap.get(RSA.PRIVATE_KEY);
        //System.out.println("publickey:==========" +publickey);
        String privatekey= new String(keyMap.get(RSA.PRIVATE_KEY),"UTF-8");
        System.out.println("privatekey:==========" +new String(keyMap.get(RSA.PRIVATE_KEY)));
